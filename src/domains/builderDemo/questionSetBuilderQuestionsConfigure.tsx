...
import { IQuestionConfigureForm, questionConfigureSchema } from "./IQuestionsConfigure"
...
const QuestionSetBuilderQuestionsConfigure = () => {
  ...
  const {
    ...
    resolver: yupResolver(questionConfigureSchema) as Resolver<IQuestionConfigureForm>,
  ...
  const onSubmit = (formData: IQuestionConfigureForm) => {
    ...
    if (currentQuestionSetData && currentQuestionSetData.questions) {
      ...
      currentQuestionSetData.questions[currentQuestion - 1].help = formData.help
      currentQuestionSetData.questions[currentQuestion - 1].error = formData.error
        ...
        <>
          <div className="govuk-width-container" id="content">
            <main className="govuk-main-wrapper">
              ...
              <Content>
                Configure the questions for the {questionSetData?.title} question set.
              </Content>
              <form onSubmit={handleSubmit(onSubmit)}>
                <Header as="h2">
                  Question {currentQuestion} of {questionSetData.questions.length}.
                </Header>
                {questionSetData.questions[currentQuestion - 1].description && (
                  <Content>{questionSetData.questions[currentQuestion - 1].description}</Content>
                )}
